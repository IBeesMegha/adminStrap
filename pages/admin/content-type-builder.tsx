                        ...
                        <div className="bg-purple-50 border-l-4 border-purple-400 ml-16 mr-4 mb-2 rounded">
                          <div className="p-4">
                            ...
                            <div className="space-y-2">
                              {componentDefinitions[field.componentRef].fields?.fields?.map((subField: Field, subIndex: number) => (
                                <div key={subIndex} className="flex items-center space-x-3 p-2 bg-white rounded border border-purple-200">
                                  <div className={`w-8 h-8 rounded flex items-center justify-center flex-shrink-0 ${
                                    subField.type === 'component' ? 'bg-purple-100' :
                                    subField.type === 'relation' ? 'bg-blue-100' :
                                    subField.type === 'media' ? 'bg-pink-100' :
                                    'bg-green-100'
                                  }`}>
