...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  // Auto-expand Content Manager sections based on current route
  React.useEffect(() => {
    if (!mounted) return;
      ...
      <nav className="px-4 space-y-6">
                ...
                >
                  ...
                  <div className="flex items-center space-x-2">
                    {/* <button
                      onClick={(e) => {
                        e.stopPropagation();
                        router.push('/admin/content-type-builder?type=single');
                      }}
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-xs uppercase text-gray-400 font-semibold px-3">
              Components
            </h3>
            <button
              onClick={() => router.push('/admin/content-type-builder?type=component')}
              className="text-gray-400 hover:text-white"
            >
              <Plus size={16} />
            </button>
